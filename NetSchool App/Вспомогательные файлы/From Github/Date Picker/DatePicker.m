...
+ (id)pickerWithDate:(NSDate *)date start:(NSDate *)start end:(NSDate *)end selectedBlock:(AIDatePickerDateBlock)selectedBlock cancelBlock:(AIDatePickerVoidBlock)cancelBlock {
    ...
    datePickerController.datePicker.minimumDate = start;
    datePickerController.datePicker.maximumDate = end;
...
- (id)init {
    ...
    [_datePicker setValue:[UIColor colorWithRed: 80 / 255.0 green: 80 / 255.0 blue: 80 / 255.0 alpha:1.0] forKey:@"textColor"];
    
//    _datePicker.tintColor = [UIColor colorWithRed: 80 / 255.0 green: 80 / 255.0 blue: 80 / 255.0 alpha:1.0];
    if ([_datePicker respondsToSelector:sel_registerName("setHighlightsToday:")]) {
        
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wundeclared-selector"
        
        [_datePicker performSelector:@selector(setHighlightsToday:) withObject:[NSNumber numberWithBool:NO]];
...
- (void)viewDidLoad {
    ...
    [_cancelButton setTitle:NSLocalizedString(@"Отменить", nil) forState:UIControlStateNormal];
    [_cancelButton setTitleColor:[UIColor colorWithRed:74 / 255.0 green:88 / 255.0 blue:94 / 255.0 alpha:1.0] forState:UIControlStateNormal];
    ...
    [_selectButton setTitle:NSLocalizedString(@"Выбрать", nil) forState:UIControlStateNormal];
    [_selectButton setTitleColor:[UIColor colorWithRed:74 / 255.0 green:88 / 255.0 blue:94 / 255.0 alpha:1.0] forState:UIControlStateNormal];
    ...
    fontSize = _cancelButton.titleLabel.font.pointSize;
    _cancelButton.titleLabel.font = [UIFont boldSystemFontOfSize:fontSize];
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[_dismissButton][_datePickerContainerView]-10-[_buttonContainerView(40)]-50-|"
                                                                      options:0
                                                                      metrics:nil
                                                                        views:views]];
}
