//
//  CollectionViewLayoutMiddleMarks.swift
//  NetSchool App
//
//  Created by Arthur on 23.07.2018.
//  Copyright © 2018 Руднев Кирилл. All rights reserved.
//
import UIKit

class CollectionViewLayoutMiddleMarks: UICollectionViewLayout {
...
// MARK: - Helpers
extension CollectionViewLayoutMiddleMarks {
    ...
    func sizeForItemWithColumnIndex(_ columnIndex: Int) -> CGSize {
        var text: [NSString] = ["Физическая культура", "Балл ученика", "Балл класса"]
        var sum: CGFloat = 0
        for k in text{
